RSpec.describe 'POST  /api/images', type: :request do
  before do
    stub_request(:post,
                 'https://safe-for-work-api.herokuapp.com/api/analyses').with(body: { analysis: {
                                                                                resource: 'https://post.healthline.com/wp-content/uploads/2020/09/health-benefits-omega-3-1200x628-facebook-1200x628.jpg', category: 'image'
                                                                              } })
  end
